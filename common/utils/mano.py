...
class MANO(object):
    ...
    def get_layer(self):
        # flat_hand_mean=True by yqwang
        return ManoLayer(mano_root=osp.join("./common/utils/manopth", "mano", "models"), flat_hand_mean=True, use_pca=False)  # load right hand MANO model
