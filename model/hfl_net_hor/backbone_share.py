...
class FPN(nn.Module):
    ...
    def forward(self, x, return_feat=False):
        ...
        c3_h = self.layer2_h(c2_h)  # c3_h is the earliest feature for hand-only
        ...
        if return_feat:
            feats_dict = {"c3_h": c3_h}
            feats_dict.update({"c1_h": c1_h, "c2_h": c2_h, "c3_o": c3_o})
            return p2_h , p2_o, feats_dict
        else:
            return p2_h , p2_o
