...
class mano_regHead(nn.Module):
    ...
    def forward(self, features, mano_params=None, roots3d=None, return_feat=False):
        ...
        if return_feat:
            feat_dict = {"mano_features": mano_features}
            return pred_mano_results, gt_mano_results, feat_dict
        else:
