...
from model.kypt_transformer.common.nets.layer import make_linear_layers, make_conv_layers, make_deconv_layers, make_upsample_layers
from model.kypt_transformer.common.nets.resnet import ResNetBackbone
import math
...
class BackboneNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.resnet = ResNetBackbone(self.cfg.resnet_type)
...
class DecoderNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.resnet_decoder = Decoder(cfg)
...
class DecoderNet_big(nn.Module):
    def __init__(self, cfg):
        ...
        self.resnet_decoder = Decoder_big(cfg)
