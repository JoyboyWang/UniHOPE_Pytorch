...
def hungarian_match_2djoints(joint_loc_gt_np, joint_loc_pred_np, joint_valid_np, mask, joint_class_pred, cfg):
    mid_dist_th = 2
...
def nearest_match_2djoints(joint_loc_gt_np, joint_loc_pred_np, joint_valid_np, mask, joint_class_pred, joints_3d_gt_np,
                           peak_joints_map_batch_np, target_obj_kps_heatmap_np, obj_kps_coord_gt_np, obj_kps_3d_gt_np, cfg):
    mid_dist_th = 3
    gt_inds_batch = []
    row_inds_batch = []
...
def get_src_memory_mask(peak_joints_map_batch, cfg):
    src_mask_list = []
    memory_mask_list = []
