...
# yqwang
smplx_path = "common/utils/manopth"

# mano_layer = {'right': smplx.create(smplx_path, 'mano/models', use_pca=False, is_rhand=True),
#               'left': smplx.create(smplx_path, 'mano/models', use_pca=False, is_rhand=False)}
mano_layer = {'right': smplx.create(smplx_path, 'mano/models', use_pca=False, is_rhand=True, flat_hand_mean=True),
            'left': smplx.create(smplx_path, 'mano/models', use_pca=False, is_rhand=False, flat_hand_mean=True)}
...
smpl_data_hands = {}
smpl_data_hands['left'] = loadPickleData(osp.join(smplx_path, 'mano/models', 'MANO_LEFT.pkl'))
smpl_data_hands['right'] = loadPickleData(osp.join(smplx_path, 'mano/models', 'MANO_RIGHT.pkl'))
