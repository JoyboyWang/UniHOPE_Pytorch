...
class mano_regHead(nn.Module):
    ...
    def forward(self, features, gt_mano_params=None):
        ...
        #     gt_mano_results = {"verts3d": gt_verts, "joints3d": gt_joints, "mano_shape": gt_mano_shape, "mano_pose": gt_mano_pose_rotmat}
        # else:
        ...
        #     pred_mano_results = {"verts3d": pred_verts3d, "joints3d": pred_joints3d}
        # else:
        #     pred_mano_results = {
        #         "verts3d": pred_verts,
