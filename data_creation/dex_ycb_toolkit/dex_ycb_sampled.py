...
os.environ['DEX_YCB_DIR'] = 'data/DexYCB'
...
class DexYCBDatasetSampled():
  ...
  def __init__(self, setup, split, sample_factor):
    ...
    # sample the sequence both in train and test
    sequence_ind_sampled = [i for i, ind in enumerate(sequence_ind) if i % sample_factor == 0]
    sequence_ind = sequence_ind_sampled
